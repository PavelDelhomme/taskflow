...
async def suggest_next_task(current_user = Depends(get_current_user)):
    ...
    with get_db() as cursor:
        ...
        best_hour = best_hour_data['context_hour'] if best_hour_data else current_hour
        ...
        current_energy = energy_data['energy_level'] if energy_data and energy_data.get('energy_level') else 3
