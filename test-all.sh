...
echo -e "     - Test Checklist: ${CYAN}Test Checklist (Environnement)-$TIMESTAMP.txt${NC}"
echo -e "     - Tests Complets: ${CYAN}Tests Complets (API & Fonctionnalités)-$TIMESTAMP.txt${NC}"
echo -e "     - Tests Étendus: ${CYAN}Tests Étendus (Validation & CRUD)-$TIMESTAMP.txt${NC}"
echo -e "     - Tests Notifications: ${CYAN}Tests de Notifications-$TIMESTAMP.txt${NC}"
echo ""
echo -e "  ${BLUE}💡 Pour générer un rapport HTML détaillé:${NC} ${CYAN}make test-report${NC}"
echo ""
